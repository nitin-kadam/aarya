             ...
             <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="demo-form" action="{{ url('add_blog_action')}}" method="POST" enctype="multipart/form-data"> 
                      ...
                      <input type="text" id="heading" class="form-control" name="heading" value="{{old('heading')}}" autocomplete="off" />
                       @error('heading')
                      ...
                      <input type="text" id="subheading" class="form-control" name="subheading" value="{{old('subheading')}}" autocomplete="off" />
                      @error('subheading')
                      <div class="alert alert-danger" id="error">{{ $message }}</div>
                      @enderror
                      ...
                      <textarea rows="3" class="form-control" name="description" id="editor1" value="{{ old('description')}}"></textarea>
                      @error('description')
