                  ...
                  <div class="x_content">
                    <form id="demo-form" action="{{ url('client_action')}}" method="POST" enctype="multipart/form-data"> 
                     ...
                     <label for="Email">Email * :</label>
                      ...
                      <textarea rows="3" class="form-control" name="description" id="editor" value="{{ old('description')}}"></textarea>
                      @error('description')
                      <div class="alert alert-danger" id="description_error">{{ $message }}</div>
                      @enderror                        
                      
                      <label for="client_image">Service Image * :</label>
                      <input type="file" id="client_image" class="form-control" name="client_image" value="{{old('client_image')}}">                   
                       @error('profile')
                      <div class="alert alert-danger" id="error">{{ $message }}</div>
                         @enderror 
                          <br/>
