          ...
          <div class="">
            ...
            <div class="clearfix"></div>           
             ...
             <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="demo-form" action="{{ url('client_action')}}" method="POST" enctype="multipart/form-data"> 
                      <label for="Name">Name * :</label>
                      <input type="text" id="name" class="form-control" name="name" value="{{$client->name}}" autocomplete="off" readonly="">
                       @error('name')
                     ...
                     <label for="Email">Email * :</label>
                      <input type="text" id="email" class="form-control" name="email" value="{{ $client->email}}" autocomplete="off" readonly="">
                       @error('email')
                      <div class="alert alert-danger" id="error">{{ $message }}</div>
                       @enderror 

                      <label for="description">Description * :</label>
                      <textarea rows="3" class="form-control" name="description" id="editor" value="{{ $client->description }}" readonly="">{{ $client->description }}</textarea>
                      @error('description')
